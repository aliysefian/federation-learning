    ...
    for i in range(times):
        ...
        if(model == "mclr"):
            if(dataset == "Mnist"):
                ...
                print("statrt")
                model = Mclr_Logistic(22,5).to(device), model
        ...
        if(model == "cnn"):
            if(dataset == "Mnist"):
                ...
                model = Mclr_Logistic(19,6).to(device), model
            # 
        if(model == "dnn"):
            if(dataset == "Mnist"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--numusers", type=int, default=286, help="Number of Users per round")
